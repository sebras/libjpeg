...
COBJECTS= cjpeg.o rdppm.o rdgif.o rdtarga.o rdbmp.o
DOBJECTS= djpeg.o wrppm.o wrgif.o wrtarga.o wrbmp.o rdcolmap.o
...
test: cjpeg djpeg
	...
	djpeg -dct int -outfile testout.ppm  testorig.jpg
